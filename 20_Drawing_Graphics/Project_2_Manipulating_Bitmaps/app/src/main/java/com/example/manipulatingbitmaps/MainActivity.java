...
public class MainActivity extends Activity {
    //Here all the objects (instances) of classes that we need to do some drawing
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initialize the Canvas and associate it with the Bitmap to draw on
        ...
        //Tell Android to set our drawing as the view for this app via the ImageView
    ...
    void drawRotatedBitmaps() {
        ...
        for (rotation = 0; rotation < 360; rotation += 30) {
            ...
            rotatedBitmap = Bitmap.createBitmap(bobBitmap, 0, 0,
                    bobBitmap.getWidth() - 1, bobBitmap.getHeight() - 1,
                    matrix, true);
