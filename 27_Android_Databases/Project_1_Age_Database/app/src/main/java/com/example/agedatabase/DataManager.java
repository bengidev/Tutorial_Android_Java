...
public class DataManager {
    ...
    /*
     * Next we have a public static final string for each row/table
     * that we need to refer to both inside and outside this class
     * */
     ...
     * each row/table that we need to refer to just inside this class
     * */
    ...
    private class CustomSQLiteOpenHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            //No need in this app but we must still override it
        }
    }
